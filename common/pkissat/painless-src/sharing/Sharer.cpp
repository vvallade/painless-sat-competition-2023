...
Sharer::printStats()
{
   ...
   cout << "c Sharer " << id << " received cls "<< stats.receivedClauses
        << ", shared cls " << stats.sharedClauses << ", received duplicas " << stats.receivedDuplicas
        << ", promotionTiers2 " << stats.promotionTiers2 << ", promotionsCore " << stats.promotionCore
        << ", alreadyTiers2 " << stats.alreadyTiers2 << ", alreadyCore " << stats.alreadyCore
        << endl;
}
